...
const AboutClub = () => {
  return (
    <section className="px-6 py-12 lg:px-20 bg-base-100 text-white">
      <div className="max-w-5xl mx-auto">
        <h2 className="text-4xl lg:text-5xl font-bold text-center mb-10 text-[#49524f]">About the Club</h2>

        <div className="space-y-10">

          {/* History */}
          <div className="card bg-[#76b38f] shadow-xl p-6">
            <h3 className="text-2xl font-semibold mb-4 text-[#49524f]">Our History</h3>
          ...
          {/* Mission */}
          <div className="card bg-[#76b38f] shadow-xl p-6">
            <h3 className="text-2xl font-semibold mb-4 text-[#49524f]">Our Mission</h3>
            <p className="text-lg leading-relaxed">
          ...
          {/* Vision (Optional) */}
          <div className="card bg-[#76b38f] shadow-xl p-6">
            <h3 className="text-2xl font-semibold mb-4 text-[#49524f]">Our Vision</h3>
            <p className="text-lg leading-relaxed">
